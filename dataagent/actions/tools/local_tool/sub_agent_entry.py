...
_SUBPROCESS_STDIO_ENCODING = "utf-8"


def _write_stdout_json(payload: dict[str, Any]) -> None:
    """Write protocol JSON as UTF-8 bytes (Windows console default may be GBK)."""
    data = json.dumps(payload, ensure_ascii=False).encode(_SUBPROCESS_STDIO_ENCODING)
...
def main() -> int:
    ...
    try:
        ...
        _write_stdout_json(error_payload)
        return 1
